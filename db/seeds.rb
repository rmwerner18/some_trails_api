...
user = User.create(:username => "Ian", :password => "12345", :bio => "I love to Hike", :image => "https://images.pexels.com/photos/1578750/pexels-photo-1578750.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")
user = User.create(:username => "Banana", :password => "12345", :bio => "I love to Hike", :image => "https://images.pexels.com/photos/1578750/pexels-photo-1578750.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")

Hike.create(user_id: user.id, trail_id: trail4.id, name: "Saturday Morning Hike", start: "2001-02-03T04:05:06", end: "2001-02-05T04:05:06", length: 26.2, photos: [])
